...
This is the most important piece of business logic in the app and the part most likely to be subtly wrong if reimplemented from a paraphrase instead of the exact code. Read this section carefully, then reproduce the code in §6.5 verbatim.
